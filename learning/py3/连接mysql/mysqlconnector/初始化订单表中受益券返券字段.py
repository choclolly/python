...
if __name__ == '__main__':
    # 受益券数据库
    with DB(host='47.95.114.54', port=3306, database='test_yestae_coin', user='test_yestae_coin',
            passwd='u16xbyyxmkVCxxs') as db_coin:
        na = (1, 1, 0.00)
        ...
        for x in result:
            ...
            with DB(host="59.110.228.110", port="3306", user="test_tea_uc", passwd="pw@kbm9p0Yl@!t3bZD",
                ...
                for y in result:
                    ...
                    modify_record = []
                    # test
                    with DB(host="59.110.228.110", port="3306", user="tea_admin_mall", passwd="euRyC7S1Il75AiI",
                            database="tea_admin_mall") as order_0:
                    ...
                    if int(str(user_num)) % 3 == 0:
                        with DB(host="shard-order-0-master", port="3306", user="tea_admin_mall",

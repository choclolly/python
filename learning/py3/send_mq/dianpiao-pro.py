...
def send_message():
    ...
    channel.queue_declare(queue='order_electronic_invoice_queue', durable=True)
    failNum = succNum = 0
    array = []
    ...
    for message in array:
        try:
            channel.basic_publish(exchange='port.notify.exchange', routing_key='order.electronic.invoice.queue',
